...
public class CheckmultiplebrknURL {
	...
	public static void main(String[] args) throws MalformedURLException, IOException {
		...
		for(WebElement link : links)
		{
			...
			// Above is hard assertion to give soft assertion create soft assertion by Sodt Assert methods
			// first need to import SoftAsser eg SoftAssert a = new SoftAssert();
